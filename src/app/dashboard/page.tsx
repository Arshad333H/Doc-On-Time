...
import { MenuActiveSwitch } from "@/app/components/EventTypeSwitch";
        ...
        <>
          <div className="flex items-center justify-between px-2">
            <div className="hidden sm:grid gap-y-1">
              <h1 className="text-3xl md:text-4xl font-semibold">EventTypes</h1>
              <p className="text-muted-foreground">
                Create and manage events right here
              </p>
            </div>
            <Button>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 ">
            {data.eventType.map((item) => (
              ...
              >
                ...
                <div className="bg-muted px-5 py-3 items-center justify-between flex">
                  <MenuActiveSwitch
