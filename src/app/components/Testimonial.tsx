      ...
      <div className="relative  max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <blockquote className="text-center lg:mx-auto lg:w-3/5">
          <div className="">
            <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium ">
              ...
              <span className="relative z-10 ">
                Wow <span className="text-primary">DocOnTime</span> is the best
                platform i have ever used. Definitely Recommend it to you guys,
                try it out!
              </span>
            </p>
          </div>
          <footer className="mt-6">
            ...
            <div className="font-semibold ">Arshad Shareef</div>
            <div className="mb-20  overflow-hidden flex max-h-screen w-full">
              <svg
                className="absolute animate-pulse inset-0 -mt-9 blur-3xl"
                style={{ zIndex: -1 }}
                fill="none"
                viewBox="0 0 400 400"
                height="100%"
